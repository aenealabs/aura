#!/bin/bash
#
# Project Aura - Deploy Chat Assistant CodeBuild Project
#
# This script deploys the CodeBuild project for the Chat Assistant (Layer 6.7: WebSocket API, Bedrock Chat).
# Run this ONCE per environment to set up the Chat Assistant CI/CD pipeline.
#
# Usage:
#   ./deploy/scripts/deploy-chat-assistant-codebuild.sh dev
#   ./deploy/scripts/deploy-chat-assistant-codebuild.sh qa
#   ./deploy/scripts/deploy-chat-assistant-codebuild.sh prod
#
...
echo "=========================================="
echo "Project Aura - Chat Assistant CodeBuild"
echo "=========================================="
...
STACK_NAME="${PROJECT_NAME}-codebuild-chat-assistant-${ENVIRONMENT}"

echo -e "${BLUE}Deploying Chat Assistant CodeBuild stack: $STACK_NAME${NC}"
echo "This will create:"
echo "  - CodeBuild project for Chat Assistant deployment"
echo "  - S3 bucket for Lambda deployment packages"
echo "  - IAM roles with Lambda/API Gateway/DynamoDB/Bedrock permissions"
...
aws cloudformation $OPERATION \
    --stack-name $STACK_NAME \
    --template-body file://deploy/cloudformation/codebuild-chat-assistant.yaml \
    --parameters \
    ...
    --tags \
        ...
        Key=Layer,Value=chat-assistant \
...
echo ""
echo "=========================================="
echo "Chat Assistant CodeBuild Outputs"
echo "=========================================="
...
echo ""
echo "=========================================="
echo "Chat Assistant CI/CD Pipeline Ready!"
echo "=========================================="
