...
#
# This script deploys the CodeBuild project for the Data Layer (Neptune, OpenSearch, DynamoDB, S3).
# Run this ONCE per environment to set up the Data Layer CI/CD pipeline.
#
# Usage:
#   ./deploy/scripts/deploy-data-codebuild.sh dev
#   ./deploy/scripts/deploy-data-codebuild.sh qa
#   ./deploy/scripts/deploy-data-codebuild.sh prod
#
...
echo "=========================================="
echo "Project Aura - Data Layer CodeBuild"
echo "=========================================="
...
echo -e "${BLUE}Deploying Data Layer CodeBuild stack: $STACK_NAME${NC}"
echo "This will create:"
echo "  - CodeBuild project for Neptune/OpenSearch/DynamoDB/S3 deployment"
echo "  - IAM roles with database and storage permissions"
...
echo ""
echo "=========================================="
echo "Data Layer CodeBuild Outputs"
echo "=========================================="
...
echo ""
echo "=========================================="
echo "Data Layer CI/CD Pipeline Ready!"
echo "=========================================="
