#!/bin/bash
#
# Project Aura - Deploy Sandbox Layer CodeBuild Project
#
# This script deploys the CodeBuild project for the Sandbox Layer (HITL Testing).
# Run this ONCE per environment to set up the Sandbox Layer CI/CD pipeline.
#
# Usage:
#   ./deploy/scripts/deploy-sandbox-codebuild.sh dev
#   ./deploy/scripts/deploy-sandbox-codebuild.sh qa
#   ./deploy/scripts/deploy-sandbox-codebuild.sh prod
#
...
echo "=========================================="
echo "Project Aura - Sandbox Layer CodeBuild"
echo "=========================================="
...
STACK_NAME="${PROJECT_NAME}-codebuild-sandbox-${ENVIRONMENT}"

echo -e "${BLUE}Deploying Sandbox Layer CodeBuild stack: $STACK_NAME${NC}"
echo "This will create:"
echo "  - CodeBuild project for Sandbox/HITL Testing deployment"
echo "  - IAM roles with EKS/DynamoDB/CloudWatch permissions"
...
echo ""
echo "=========================================="
echo "Sandbox Layer CodeBuild Outputs"
echo "=========================================="
...
echo ""
echo "=========================================="
echo "Sandbox Layer CI/CD Pipeline Ready!"
echo "=========================================="
