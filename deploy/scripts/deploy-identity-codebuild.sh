#!/bin/bash
#
# Project Aura - Deploy Identity CodeBuild Project
#
# This script deploys the CodeBuild project for Multi-IdP Authentication (Layer 4.12: Identity Provider Infrastructure).
# Run this ONCE per environment to set up the Identity CI/CD pipeline.
#
# Usage:
#   ./deploy/scripts/deploy-identity-codebuild.sh dev
#   ./deploy/scripts/deploy-identity-codebuild.sh qa
#   ./deploy/scripts/deploy-identity-codebuild.sh prod
#
...
echo "=========================================="
echo "Project Aura - Identity CodeBuild"
echo "=========================================="
...
STACK_NAME="${PROJECT_NAME}-codebuild-identity-${ENVIRONMENT}"

echo -e "${BLUE}Deploying Identity CodeBuild stack: $STACK_NAME${NC}"
echo "This will create:"
echo "  - CodeBuild project for Identity deployment"
echo "  - IAM roles with DynamoDB/KMS permissions"
...
aws cloudformation $OPERATION \
    --stack-name $STACK_NAME \
    --template-body file://deploy/cloudformation/codebuild-application-identity.yaml \
    --parameters \
    ...
    --tags \
        ...
        Key=Layer,Value=identity \
        Key=ADR,Value=ADR-054 \
...
echo ""
echo "=========================================="
echo "Identity CodeBuild Outputs"
echo "=========================================="
...
echo ""
echo "=========================================="
echo "Identity CI/CD Pipeline Ready!"
echo "=========================================="
