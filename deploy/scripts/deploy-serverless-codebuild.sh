#!/bin/bash
#
# Project Aura - Deploy Serverless Layer CodeBuild Project
#
# This script deploys the CodeBuild project for the Serverless Layer (Lambda + EventBridge).
# Run this ONCE per environment to set up the Serverless Layer CI/CD pipeline.
#
# Usage:
#   ./deploy/scripts/deploy-serverless-codebuild.sh dev
#   ./deploy/scripts/deploy-serverless-codebuild.sh qa
#   ./deploy/scripts/deploy-serverless-codebuild.sh prod
#
...
echo "=========================================="
echo "Project Aura - Serverless Layer CodeBuild"
echo "=========================================="
...
STACK_NAME="${PROJECT_NAME}-codebuild-serverless-${ENVIRONMENT}"

echo -e "${BLUE}Deploying Serverless Layer CodeBuild stack: $STACK_NAME${NC}"
echo "This will create:"
echo "  - CodeBuild project for Lambda/EventBridge deployment"
echo "  - S3 bucket for Lambda deployment packages"
echo "  - IAM roles with Lambda/EventBridge/SNS/Secrets permissions"
...
echo ""
echo "=========================================="
echo "Serverless Layer CodeBuild Outputs"
echo "=========================================="
...
echo ""
echo "=========================================="
echo "Serverless Layer CI/CD Pipeline Ready!"
echo "=========================================="
