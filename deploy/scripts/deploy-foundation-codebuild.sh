...
#
# This script deploys the CodeBuild project for the Foundation Layer (VPC, IAM, WAF, VPC Endpoints).
# Run this ONCE per environment to set up the Foundation Layer CI/CD pipeline.
#
# Usage:
...
echo "=========================================="
echo "Project Aura - Foundation Layer CodeBuild"
echo "=========================================="
...
echo -e "${BLUE}Deploying Foundation Layer CodeBuild stack: $STACK_NAME${NC}"
echo "This will create:"
echo "  - CodeBuild project for VPC/IAM/WAF/VPC Endpoints deployment"
echo "  - IAM roles with networking and security permissions"
...
echo ""
echo "=========================================="
echo "Foundation Layer CodeBuild Outputs"
echo "=========================================="
...
echo ""
echo "=========================================="
echo "Foundation Layer CI/CD Pipeline Ready!"
echo "=========================================="
