...
**Key Documents:**
- Performance Analysis: `../experiments/hybrid-memory-architecture/PERFORMANCE_ANALYSIS.md`
- Resource Scaling: `../experiments/hybrid-memory-architecture/RESOURCE_SCALING_GUIDE.md`
- Enterprise Tiers: `../experiments/hybrid-memory-architecture/ENTERPRISE_TIER_CONFIG.md`
...
4. Research Analysis: `../papers/neural-memory-2025/TITANS_MIRAS_ANALYSIS.md`

---

*ADR-024 v1.0 - Proposed December 6, 2025*
