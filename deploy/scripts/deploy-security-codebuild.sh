#!/bin/bash
#
# Project Aura - Deploy Security Layer CodeBuild Project
#
# This script deploys the CodeBuild project for the Security Layer (AWS Config, GuardDuty).
# Run this ONCE per environment to set up the Security Layer CI/CD pipeline.
#
# Usage:
#   ./deploy/scripts/deploy-security-codebuild.sh dev
#   ./deploy/scripts/deploy-security-codebuild.sh qa
#   ./deploy/scripts/deploy-security-codebuild.sh prod
#
...
echo "=========================================="
echo "Project Aura - Security Layer CodeBuild"
echo "=========================================="
...
STACK_NAME="${PROJECT_NAME}-codebuild-security-${ENVIRONMENT}"

echo -e "${BLUE}Deploying Security Layer CodeBuild stack: $STACK_NAME${NC}"
echo "This will create:"
echo "  - CodeBuild project for AWS Config/GuardDuty deployment"
echo "  - IAM roles with security and compliance permissions"
...
aws cloudformation $OPERATION \
    ...
    --template-body file://deploy/cloudformation/codebuild-security.yaml \
    --parameters \
...
echo ""
echo "=========================================="
echo "Security Layer CodeBuild Outputs"
echo "=========================================="
...
echo ""
echo "=========================================="
echo "Security Layer CI/CD Pipeline Ready!"
echo "=========================================="
