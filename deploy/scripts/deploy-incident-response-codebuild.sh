#!/bin/bash
#
# Project Aura - Deploy Incident Response Layer CodeBuild Project
#
# This script deploys the CodeBuild project for the Incident Response Layer (Layer 6.5).
# Run this ONCE per environment to set up the Incident Response Layer CI/CD pipeline.
#
# Usage:
#   ./deploy/scripts/deploy-incident-response-codebuild.sh dev
#   ./deploy/scripts/deploy-incident-response-codebuild.sh qa
#   ./deploy/scripts/deploy-incident-response-codebuild.sh prod
#
...
echo "=========================================="
echo "Project Aura - Incident Response Layer CodeBuild"
echo "=========================================="
...
STACK_NAME="${PROJECT_NAME}-codebuild-incident-response-${ENVIRONMENT}"

echo -e "${BLUE}Deploying Incident Response Layer CodeBuild stack: $STACK_NAME${NC}"
echo "This will create:"
echo "  - CodeBuild project for Incident Response deployment"
echo "  - S3 bucket for artifacts"
echo "  - IAM roles with DynamoDB/Lambda/Step Functions/ECS/EventBridge/SNS permissions"
...
aws cloudformation $OPERATION \
    ...
    --template-body file://deploy/cloudformation/codebuild-incident-response.yaml \
    --parameters \
    ...
    --tags \
        ...
        Key=Layer,Value=incident-response \
...
echo ""
echo "=========================================="
echo "Incident Response Layer CodeBuild Outputs"
echo "=========================================="
...
echo ""
echo "=========================================="
echo "Incident Response Layer CI/CD Pipeline Ready!"
echo "=========================================="
